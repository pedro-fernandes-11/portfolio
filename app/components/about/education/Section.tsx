...
export default function Section() {
  ...
  const sectionDetails: SectionDetails = {
    title: "Education",
    subject: "Highlights of my academic background",
    descripion:
      "A strong academic foundation supports my professional growth, combining rigorous coursework and hands-on learning to adapt and excel in evolving fields.",
  };
  ...
  return (
    <div>
      <SectionDescription
        Icon={<EducationIcon className="h-6" />}
